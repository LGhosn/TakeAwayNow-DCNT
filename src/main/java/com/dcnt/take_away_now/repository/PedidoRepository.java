...
public interface PedidoRepository extends JpaRepository<Pedido, Long> {
    ...
    @Query( "SELECT new com.dcnt.take_away_now.dto.PedidoDto(p.id, p.cliente.usuario, p.negocio.nombre, p.estado, p.precioTotal, p.fechaYHoraDeEntrega, p.codigoDeRetiro)" +
            "FROM Pedido p "+
