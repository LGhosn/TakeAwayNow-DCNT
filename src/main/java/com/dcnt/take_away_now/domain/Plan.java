...
public class Plan {
    ...
    public Plan (String nombre, Dinero precio, int duracion, PuntosDeConfianza puntosDeConfianza, int descuento, int multiplicadorDePuntosDeConfianza, boolean cancelacionSinCosto, int porcentajeExtraDePuntosDeConfianzaPorDevolucion) {
        this.nombre = nombre;
        this.precio = precio;
