...
public class PlanService {
    ...
    public ResponseEntity<String> crearPlan(String nombre, int precio, int duracion, int puntosDeConfiazna, int descuento, int multiplicadorPuntoDeConfianza, boolean cancelacionSinCosto, int porcentajeDePuntosDeConfianzaPorDevolucion) {
        ...
        this.planRepository.save(new Plan(nombre, new Dinero(precio), duracion, new PuntosDeConfianza(puntosDeConfiazna), descuento, multiplicadorPuntoDeConfianza, cancelacionSinCosto, porcentajeDePuntosDeConfianzaPorDevolucion));
